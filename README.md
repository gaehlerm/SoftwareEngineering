...
This is perfectly viable code in TDD. There is no duplication and it does everything required to make the test pass. As there is nothing to refactor, we can continue with the second test.
